...
type Config struct {
	...
	CudosMarketsTestFarmWalletPassword string
...
func NewConfig() *Config {
	return &Config{
		...
		CudosMarketsBackEndUrl:             getEnv("CUDOS_MARKETS_BACKEND_URL", ""),
		...
		CudosMarketsTestFarmWalletPassword: getEnv("CUDOS_MARKETS_TEST_FARM_WALLET_PASSWORD", ""),
